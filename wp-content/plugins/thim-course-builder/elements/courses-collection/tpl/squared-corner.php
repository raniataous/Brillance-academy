...
?>
	<div class="thim-courses-collection-wrapper">
		...
		<?php if ( $query_collection->have_posts() ): ?>
			<div class="thim-courses-collection squared-courses-collection" data-img="<?php echo esc_url( THIM_CB_URL . 'courses-collection/assets/images/group-3.jpg' ); ?>">
						...
						<?php while ( $query_collection->have_posts() ) : $query_collection->the_post(); ?>
							<li class="collection-item">
								...
								<div class="collection-wrapper">
									<h4 class="name"><a href="<?php echo esc_url( get_the_permalink() ); ?>"><?php echo get_the_title(); ?></a></h4>
