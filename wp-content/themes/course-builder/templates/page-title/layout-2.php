...
$show_text_course       = get_theme_mod( 'course_page_title_show_text', true );
$show_breadcrumb_course = get_theme_mod( 'course_show_breadcrumb', true );
$layouts_single_course  = get_theme_mod( 'learnpress_single_course_style', 1 );

if ( ( $show_text || $show_text_course ) && $layouts_single_course != '3' ) {
	?>
	<div class="main-top <?php echo ent2ncr( $parallax ); ?>" <?php echo ent2ncr( $main_css ); ?>>
		...
		<div class="content container">
			...
			<?php
			if ( $show_title || $show_text_course ) {
				?>
	...
	<?php
	if ( ( $show_breadcrumb || $show_breadcrumb_course ) && $layouts_single_course == '1' ) {
		?>
