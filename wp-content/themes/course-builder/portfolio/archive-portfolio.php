			...
			<?php if ( ! empty( $portfolio_taxs ) ) : ?>
                <div class="portfolio-tabs-wapper filters">
                    <ul class="portfolio-tabs">
                        <li><a href="#" class="filter active" data-filter="*"><?php echo esc_html__( 'All', 'course-builder' ); ?></a>
                        </li>
...
//						$image_crop = aq_resize( $imgurl[0], $w, $h, $crop );
						...
						$imgurl_crop_popup     = wp_get_attachment_image_src( $image_id, array(800, 640) );

//						$image_crop_popup = aq_resize( $imgurl[0], 800, 640, $crop );
						$image_crop_popup = $imgurl_crop_popup[0];
