...
<div id="pmpro_level-<?php echo $pmpro_level->id; ?>">
    <form id="pmpro_form" class="pmpro_form" action="<?php if ( ! empty( $_REQUEST['review'] ) ) {
        ...
        <?php if ( $pmpro_review ) { ?>
            <p><?php esc_html_e( 'Almost done. Review the membership information and pricing below then <strong>click the "Complete Payment" button</strong> to finish your order.', 'course-builder' ); ?></p>
        <?php } ?>
        ...
        <table id="pmpro_pricing_fields" class="pmpro_checkout" width="100%" cellpadding="0" cellspacing="0" border="0">
            ...
            <tr>
                <th>
                    <span class="pmpro_thead-name"><?php esc_html_e( 'Membership Level', 'course-builder' ); ?></span>
                    <?php if ( count( $pmpro_levels ) > 1 ) { ?><span class="pmpro_thead-msg">
                        <a href="<?php echo pmpro_url( "levels" ); ?>"><?php esc_html_e( 'change', 'course-builder' ); ?></a>
                        </span><?php } ?>
                </th>
            </tr>
            </thead>
            ...
            <tr>
                <td>
                    <p>
                        <?php printf( __( 'You have selected the <strong>%s</strong> membership level.', 'course-builder' ), $pmpro_level->name ); ?>
                    </p>
                    ...
                    <div id="pmpro_level_cost">
                        <?php if ( $discount_code && pmpro_checkDiscountCode( $discount_code ) ) { ?>
                            <?php printf( __( '<p class="pmpro_level_discount_applied">The <strong>%s</strong> code has been applied to your order.</p>', 'course-builder' ), $discount_code ); ?>
                        <?php } ?>
                    ...
                    <?php if ( $pmpro_show_discount_code ) { ?>
                        ...
                        <?php if ( $discount_code && ! $pmpro_review ) { ?>
                            <p id="other_discount_code_p" class="pmpro_small">
                                <a id="other_discount_code_a" href="#discount_code"><?php esc_html_e( 'Click here to change your discount code', 'course-builder' ); ?></a>.
                            </p>
                        <?php } elseif ( ! $pmpro_review ) { ?>
                            <p id="other_discount_code_p" class="pmpro_small"><?php esc_html_e( 'Do you have a discount code?', 'course-builder' ); ?>
                                <a id="other_discount_code_a" href="#discount_code"><?php esc_html_e( 'Click here to enter your discount code', 'course-builder' ); ?></a>.
                            </p>
                        <?php } elseif ( $pmpro_review && $discount_code ) { ?>
                            <p>
                                <strong><?php esc_html_e( 'Discount Code', 'course-builder' ); ?>:</strong> <?php echo $discount_code ?>
                            </p>
                        <?php } ?>
            ...
            <?php if ( $pmpro_show_discount_code ) { ?>
                <tr id="other_discount_code_tr" style="display: none;">
                    <td>
                        <div>
                            <label for="other_discount_code"><?php esc_html_e( 'Discount Code', 'course-builder' ); ?></label>
                            ...
                            <input type="button" name="other_discount_code_button" id="other_discount_code_button" value="<?php esc_html_e( 'Apply', 'course-builder' ); ?>" />
                        </div>
                    </td>
                </tr>
            <?php } ?>
        ...
        <?php if ( ! $skip_account_fields && ! $pmpro_review ) { ?>
            <table id="pmpro_user_fields" class="pmpro_checkout" width="100%" cellpadding="0" cellspacing="0" border="0">
                ...
                <tr>
                    <th>
                        <span class="pmpro_thead-name"><?php esc_html_e( 'Account Information', 'course-builder' ); ?></span>
                        <span class="pmpro_thead-msg small"><?php esc_html_e( 'Already have an account?', 'course-builder' ); ?>
                            <a href="<?php echo add_query_arg( 'redirect_to', pmpro_url( "checkout", "?level=" . $pmpro_level->id ), thim_get_login_page_url() ); ?>"><?php esc_html_e('Log in here', 'course-builder' );?></a>
                    </th>
                </tr>
                </thead>
                <tbody>
                <tr>
                    <td>
                        <div>
                            <label for="username"><?php esc_html_e( 'Username', 'course-builder' ); ?></label>
                        ...
                        <div>
                            <label for="password"><?php esc_html_e( 'Password', 'course-builder' ); ?></label>
                        ...
                        if ( $pmpro_checkout_confirm_password ) {
                            ?>
                            <div>
                                <label for="password2"><?php esc_html_e( 'Confirm Password', 'course-builder' ); ?></label>
                        ...
                        <div>
                            <label for="bemail"><?php esc_html_e( 'E-mail Address', 'course-builder' ); ?></label>
                        ...
                        if ( $pmpro_checkout_confirm_email ) {
                            ?>
                            <div>
                                <label for="bconfirmemail"><?php esc_html_e( 'Confirm E-mail Address', 'course-builder' ); ?></label>
                        ...
                        <div class="pmpro_hidden">
                            <label for="fullname"><?php esc_html_e( 'Full Name', 'course-builder' ); ?></label>
                            <input id="fullname" name="fullname" type="text" class="input <?php echo pmpro_getClassForField( "fullname" ); ?>" size="30" value="" />
                            <strong><?php esc_html_e( 'LEAVE THIS BLANK', 'course-builder' ); ?></strong>
                        </div>
        ...
        <?php } elseif ( $current_user->ID && ! $pmpro_review ) { ?>
            ...
            <p id="pmpro_account_loggedin">
                <?php printf( __( 'You are logged in as <strong>%s</strong>. If you would like to use a different account for this membership, <a href="%s">log out now</a>.', 'course-builder' ), $current_user->user_login, wp_logout_url( $_SERVER['REQUEST_URI'] ) ); ?>
            </p>
        <?php } ?>
        ...
        <?php if ( pmpro_getGateway() == "paypal" && empty( $pmpro_review ) && true == apply_filters( 'pmpro_include_payment_option_for_paypal', true ) ) { ?>
            <table id="pmpro_payment_method" class="pmpro_checkout top1em" width="100%" cellpadding="0" cellspacing="0" border="0" <?php if ( ! $pmpro_requirebilling ) { ?>style="display: none;"<?php } ?>>
                <thead>
                <tr>
                    <th><?php esc_html_e( 'Choose your Payment Method', 'course-builder' ); ?></th>
                </tr>
                </thead>
                <tbody>
                <tr>
                    <td>
						...
						<span class="gateway_paypal">
							...
							<a href="javascript:void(0);" class="pmpro_radio"><?php esc_html_e( 'Check Out with a Credit Card Here', 'course-builder' ); ?></a>
						</span>
							...
							<a href="javascript:void(0);" class="pmpro_radio"><?php esc_html_e( 'Check Out with PayPal', 'course-builder' ); ?></a>
						</span>
                        </div>
                    </td>
                </tr>
        ...
        if ( $pmpro_include_billing_address_fields ) {
            ...
            <table id="pmpro_billing_address_fields" class="pmpro_checkout top1em" width="100%" cellpadding="0" cellspacing="0" border="0" <?php if ( ! $pmpro_requirebilling || apply_filters( "pmpro_hide_billing_address_fields", false ) ){ ?>style="display: none;"<?php } ?>>
                <thead>
                <tr>
                    <th><?php esc_html_e( 'Billing Address', 'course-builder' ); ?></th>
                </tr>
                </thead>
                <tbody>
                <tr>
                    <td>
                        <div>
                            <label for="bfirstname"><?php esc_html_e( 'First Name', 'course-builder' ); ?></label>
                        ...
                        <div>
                            <label for="blastname"><?php esc_html_e( 'Last Name', 'course-builder' ); ?></label>
                        ...
                        <div>
                            <label for="baddress1"><?php esc_html_e( 'Address 1', 'course-builder' ); ?></label>
                        ...
                        <div>
                            <label for="baddress2"><?php esc_html_e( 'Address 2', 'course-builder' ); ?></label>
                        ...
                        if ( $longform_address ) {
                            ?>
                            <div>
                                <label for="bcity"><?php esc_html_e( 'City', 'course-builder' ); ?></label>
                            ...
                            <div>
                                <label for="bstate"><?php esc_html_e( 'State', 'course-builder' ); ?></label>
                            ...
                            <div>
                                <label for="bzipcode"><?php esc_html_e( 'Postal Code', 'course-builder' ); ?></label>
                            ...
                            ?>
                            <div>
                                <label for="bcity_state_zip"><?php esc_html_e( 'City, State Zip', 'course-builder' ); ?></label>
                        ...
                        if ( $show_country ) {
                            ?>
                            <div>
                                <label for="bcountry"><?php esc_html_e( 'Country', 'course-builder' ); ?></label>
                        ...
                        ?>
                        <div>
                            <label for="bphone"><?php esc_html_e( 'Phone', 'course-builder' ); ?></label>
                        ...
                        <?php if ( $skip_account_fields ) { ?>
                            ...
                            if ( $pmpro_checkout_confirm_email ) {
                                ?>
                                <div>
                                    <label for="bconfirmemail"><?php esc_html_e( 'Confirm E-mail', 'course-builder' ); ?></label>
                                    <input id="bconfirmemail" name="bconfirmemail" type="<?php echo( $pmpro_email_field_type ? 'email' : 'text' ); ?>" class="input <?php echo pmpro_getClassForField( "bconfirmemail" ); ?>" size="30" value="<?php echo esc_attr( $bconfirmemail ) ?>" />
        ...
        if ( $pmpro_include_payment_information_fields ) {
            ...
            <table id="pmpro_payment_information_fields" class="pmpro_checkout top1em" width="100%" cellpadding="0" cellspacing="0" border="0" <?php if ( ! $pmpro_requirebilling || apply_filters( "pmpro_hide_payment_information_fields", false ) ) { ?>style="display: none;"<?php } ?>>
                ...
                <tr>
                    <th>
                        <span class="pmpro_thead-name"><?php esc_html_e( 'Payment Information', 'course-builder' ); ?></span>
                        <span class="pmpro_thead-msg"><?php printf( __( 'We Accept %s', 'course-builder' ), $pmpro_accepted_credit_cards_string ); ?></span>
                    </th>
                </tr>
                </thead>
                <tbody>
                    ...
                    <td>
                        ...
                        if ( $pmpro_include_cardtype_field ) {
                            ...
                            <div class="pmpro_payment-card-type">
                                <label for="CardType"><?php esc_html_e( 'Card Type', 'course-builder' ); ?></label>
                        ...
                        <div class="pmpro_payment-account-number">
                            <label for="AccountNumber"><?php esc_html_e( 'Card Number', 'course-builder' ); ?></label>
                        ...
                        <div class="pmpro_payment-expiration">
                            <label for="ExpirationMonth"><?php esc_html_e( 'Expiration Date', 'course-builder' ); ?></label>
                        ...
                        if ( $pmpro_show_cvv ) { ?>
                            <div class="pmpro_payment-cvv">
                                <label for="CVV"><?php esc_html_e( 'CVV', 'course-builder' ); ?></label>
                                ...
                                <small>(<a href="javascript:void(0);" onclick="javascript:window.open('<?php echo pmpro_https_filter( PMPRO_URL ) ?>/pages/popup-cvv.html','cvv','toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=yes, resizable=yes, width=600, height=475');"><?php esc_html_e( "what's this?", 'course-builder' ); ?></a>)
                                </small>
                            </div>
                        <?php } ?>
                        ...
                        <?php if ( $pmpro_show_discount_code ) { ?>
                            <div class="pmpro_payment-discount-code">
                                <label for="discount_code"><?php esc_html_e( 'Discount Code', 'course-builder' ); ?></label>
                                ...
                                <input type="button" id="discount_code_button" name="discount_code_button" value="<?php esc_html_e( 'Apply', 'course-builder' ); ?>" />
            ...
            <table id="pmpro_tos_fields" class="pmpro_checkout top1em" width="100%" cellpadding="0" cellspacing="0" border="0">
                ...
                <tr class="odd">
                    <td>
                        ...
                        <label class="pmpro_normal pmpro_clickable" for="tos"><?php printf( __( 'I agree to the %s', 'course-builder' ), $tospage->post_title ); ?></label>
                    </td>
                </tr>
                </tbody>
            </table>
        ...
        <div class="pmpro_submit">
            <?php if ( $pmpro_review ) { ?>
				...
				<input type="submit" class="pmpro_btn pmpro_btn-submit-checkout" value="<?php esc_html_e( 'Complete Payment', 'course-builder' ); ?> &raquo;" />
			</span>
            ...
            <?php } else { ?>
                ...
                if ( $pmpro_checkout_default_submit_button ) {
					...
					<input type="submit" class="pmpro_btn pmpro_btn-submit-checkout" value="<?php if ( $pmpro_requirebilling ) {
                        esc_html_e( 'Submit and Check Out', 'course-builder' );
                    } else {
                        esc_html_e( 'Submit and Confirm', 'course-builder' );
                    } ?> &raquo;" />
				</span>
                    <?php
                }
			...
			<?php
            $processing_message = apply_filters( "pmpro_processing_message", __( "Processing...", 'course-builder' ) );
